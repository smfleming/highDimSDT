...
def plot(args):
	...
	for r in range(args.N_runs):
		# Run directory
		run_dir = f'./classes{args.n_classes}_{args.new_n_classes}/run' + str(r+1) + '/'
		# Load test results
	...
	df.to_csv(f'./df{args.n_classes}_{args.new_n_classes}_ta{int(target_acc*100)}.csv', index=False)

	# Stats
	# Open file
	stats_fname = f'./PE_stats{args.n_classes}_{args.new_n_classes}.txt'
	...
	# Save plot
	plot_fname = f'./PE_bias_MNIST{args.n_classes}_{args.new_n_classes}_ta{int(target_acc*100)}.png'
